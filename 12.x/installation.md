...
> Commit ID: [68c1d757aa86b2ebecf5f4085564c96241b57a82](https://github.com/laravel/docs/blob/12.x/installation.md)

<a name="meet-laravel"></a>
## ‌初识 Laravel

Laravel 是以优雅语法与高表达力著称的 Web 应用框架。作为开发工具，该框架为应用构建提供结构化与起点，使创造过程聚焦于核心价值，技术细节则由框架自动处理。
